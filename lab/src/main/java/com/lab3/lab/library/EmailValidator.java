...
public class EmailValidator {
	...
	public boolean validateEmail(String email) {
		...
		if (!validateRecipientsName(recipientsName))
			return false;
		if (!validateDomainName_TLD(domainName_TLD))
			return false;
